...
@ccclass("FireBallWeapon")
export class FireBallWeapon extends WeaponBase {
    @property explosionRadius = 60;
    ...
    protected attack(): void {
        ...
        const bullet = BulletPoolManager.Instance.getBullet(BulletType.FIREBALL);
        if (!bullet) return;
